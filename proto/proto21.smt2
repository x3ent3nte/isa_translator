...
(assert 
	(let 
		(
			(pre (select sequence #b000)) 
			(post (select sequence (bvadd #b000 #b001)))
			(oper (operx (select program #b000)))
			(cond (condx (select program #b000)))
			(flag (flagx (select program #b000)))
			(rd (rdx (select program #b000)))
			(rn (rnx (select program #b000)))
			(ro (rox (select program #b000)))
			(imm (immx (select program #b000)))
			(imm_used (imm_usedx (select program #b000)))
			(barrel_op (barrel_opx (select program #b000)))
			(barrel_num (barrel_numx (select program #b000)))
		)
		(or 
			(and
				; pc incremented
...
(assert (= (select (select sequence #b001) R0) #b00000000000000000000000000001111))
(assert (= (select (select sequence #b001) R1) #b00000000000000000000000000001111))
(assert (= (select (select sequence #b001) R2) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R3) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R4) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R5) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R6) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R7) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R8) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R9) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R10) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R11) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) R12) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) SP) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) LR) #b00000000000000000000000000000000))
(assert (= (select (select sequence #b001) PC) #b00000000000000000000000000000100))
(assert (= (select (select sequence #b001) CPSR) #b00000000000000000000000000000000))
