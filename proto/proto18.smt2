...
; Variables
;(declare-var n_one State)
;(declare-var n_two State)
...
(assert 
	(forall ((x (_ BitVec 3)))
		(let ((pre (select sequence x)) (post (select sequence (bvadd x #b001))))
			(or (= x #b111)
				(and
					; pc incremented
...
(assert (= (select (select sequence #b111) R1) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R2) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R3) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R4) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R5) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R6) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R7) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R8) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R9) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R10) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R11) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) R12) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) SP) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) LR) #b00000000000000000000000000000000))
;(assert (= (select (select sequence 3) PC) #b00000000000000000000000000000100))
;(assert (= (select (select sequence 3) CPSR) #b01000000000000000000000000000000))
