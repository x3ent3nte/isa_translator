...
(declare-datatypes (Operation Condition Flag BarrelOp Register) 
	((Instruction 
		(mk-Instruction 
			(oper Operation) (cond Condition) (flag Flag) 
			(rd Register) (rn Register) (ro Register) 
			(imm (_ BitVec 12)) (imm_used Bool)
			(barrel_op BarrelOp) (barrel_num (_ BitVec 32))  
		)
	)) 
)
