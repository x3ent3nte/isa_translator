...
(assert  (forall ((c Cond) (x Reg) (y Reg)) (=>  (and (= (Execute2 pre CMP c x y) post) (EvalCond pre c)) (and (=> (= (select pre x) (select pre y)) (Z1 post)) (=> (not (= (select pre x) (select pre y))) (not (Z1 post))) (EqualXCPSRPC pre post) (PCplus4 pre post)) )) )
(assert  (forall ((c Cond) (x Reg) (y Reg)) (=>  (and (= (Execute2 pre CMP c x y) post) (not (EvalCond pre c))) (and  (EqualXPC pre post) (PCplus4 pre post)) )) )
...
(assert (= (select pre R1) #b00000000000000000000000000000110))
(assert (Z1 post))
